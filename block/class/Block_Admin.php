...
class Block_Admin {
	...
	public static function sendEmail($result)
	{
		...
		$transport = Swift_SmtpTransport::newInstance('smtp.gmail.com', 465, 'ssl')
			...
			->setTo   (array('bahar_akhtary@yahoo.com'=> 'A name'))
			->setBody($result);
			//Send the message
    ...
    public static function route($action)
    {
        ...
        switch ($action) {
            case 'new':
				...
				//Block_Admin::sendEmail('newww');
				Block_Admin::sendMessage('New');
                break;
            ...
            case 'delete':
                ...
                $block->kill();
				Block_Admin::sendMessage('Without dgettext');
            ...
            case 'postBlock':
			//	Block_Admin::sendEmail('preBlock');
                if (Block_Admin::postBlock($block)) {
						
                    $result = $block->save();
					Block_Admin::sendEmail($result);
    ...
    {
		Block_Admin::sendMessage('Start editor');
